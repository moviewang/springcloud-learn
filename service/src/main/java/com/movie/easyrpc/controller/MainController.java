package com.movie.easyrpc.controller;

import com.alibaba.fastjson.JSON;
import com.movie.easyrpc.rpc.Result;
import com.movie.easyrpc.rpc.ServiceGetter;
...
public class MainController {
    @PostMapping("")
    public Result main(String identifier, String methodName, String argTypes, String argValues) {
        try {
            ...
            Object obj = ServiceGetter.getServiceByClass(clazz);
            if (obj == null) {
